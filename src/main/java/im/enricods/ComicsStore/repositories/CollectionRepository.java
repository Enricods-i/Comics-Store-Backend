...
public interface CollectionRepository extends JpaRepository<Collection,String>{
    ...
    @Query(value = "SELECT DISTINCT c.collection FROM Comic c JOIN c.authors a WHERE a.name = :authorName")
    Page<Collection> findByAuthor(String authorName, Pageable pageable);
